...
public class Interact7 : MonoBehaviour {
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hit && hit.transform.tag == "Interactable7" && currentDisplay.CurrentState != DisplayImage7.State.idle)
            {
                hit.transform.GetComponent<IInteractable7>().Interact7(currentDisplay);
            }
        }
